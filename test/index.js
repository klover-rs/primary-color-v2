...
let base64_img = get_image_from_fs();

let result1 = addon.primaryColorByBase64(base64_img);

console.log(result1);

function get_image_from_fs() {
    try {

        let image = fs.readFileSync('./test/images.jpeg', 'base64');
